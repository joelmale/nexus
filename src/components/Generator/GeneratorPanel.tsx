  ...
  return (
    <div className="generator-panel">
      <div className="panel-header">
        ...
        >
          <button
            onClick={() => setActiveGenerator('dungeon')}
            className={`glass-button ${activeGenerator === 'dungeon' ? 'primary' : 'secondary'}`}
            style={{
              width: '100%',
              textAlign: 'left',
              padding: '0.25rem',
          ...
          <button
            onClick={() => setActiveGenerator('cave')}
            className={`glass-button ${activeGenerator === 'cave' ? 'primary' : 'secondary'}`}
            style={{
              width: '100%',
              textAlign: 'left',
              padding: '0.25rem',
          ...
          <button
            onClick={() => setActiveGenerator('world')}
            className={`glass-button ${activeGenerator === 'world' ? 'primary' : 'secondary'}`}
            style={{
              width: '100%',
              textAlign: 'left',
              padding: '0.25rem',
          ...
          <button
            onClick={() => setActiveGenerator('city')}
            className={`glass-button ${activeGenerator === 'city' ? 'primary' : 'secondary'}`}
            style={{
              width: '100%',
              textAlign: 'left',
              padding: '0.25rem',
          ...
          <button
            onClick={() => setActiveGenerator('dwelling')}
            className={`glass-button ${activeGenerator === 'dwelling' ? 'primary' : 'secondary'}`}
            style={{
              width: '100%',
              textAlign: 'left',
              padding: '0.25rem',
          ...
          >
            <div
              style={{
                display: 'grid',
                gridTemplateColumns:
                  'auto 1fr auto 1fr auto 1fr auto 1fr auto 1fr',
                gap: '0.5rem 0.75rem',
                alignItems: 'center',
                columnGap: '0.75rem',
              }}
            >
              <kbd>Enter</kbd>
              <span style={{ paddingRight: '1.5rem' }}>New dungeon</span>
              <kbd>E</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Save PNG</span>
              <kbd>S</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Style</span>
              <kbd>Tab</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Tags</span>
              <kbd>J</kbd>
              <span>JSON</span>

              <kbd>G</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Grid</span>
              <kbd>N</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Notes</span>
              <kbd>L</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Legend</span>
              <kbd>H</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Secrets</span>
              <kbd>M</kbd>
              <span>Mono</span>

              <kbd>W</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Water</span>
              <kbd>Shift+W</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Water height</span>
              <kbd>P</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Props</span>
              <kbd>C</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Corners</span>
              <kbd>R</kbd>
              <span>Rotate</span>

              <kbd>Space</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Rearrange</span>
              <kbd>Shift+Space</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Reroll notes</span>
              <kbd>1</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Normal cells</span>
              <kbd>2</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Small cells</span>
              <kbd>Shift+G</kbd>
              <span>Grid mode</span>
            </div>
          </div>
        ...
        {activeGenerator === 'cave' && (
          ...
          >
            ...
            >
              <kbd>Enter</kbd>
              <span style={{ paddingRight: '1.5rem' }}>New cave</span>
              <kbd>E</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Save PNG</span>
              <kbd>S</kbd>
              <span>Style</span>
        ...
        {activeGenerator === 'world' && (
          ...
          >
            ...
            >
              <kbd>Enter</kbd>
              <span style={{ paddingRight: '1.5rem' }}>New world</span>
              <kbd>E</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Save PNG</span>
              <kbd>S</kbd>
              <span>Style</span>
        ...
        {activeGenerator === 'city' && (
          ...
          >
            ...
            >
              <kbd>Enter</kbd>
              <span style={{ paddingRight: '1.5rem' }}>New city</span>
              <kbd>E</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Save PNG</span>
              <kbd>S</kbd>
              <span>Style</span>
              ...
              <kbd>C</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Citadel</span>
              <kbd>W</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Walls</span>
              <kbd>T</kbd>
              <span>Temple</span>
            </div>
          </div>
        ...
        {activeGenerator === 'dwelling' && (
          ...
          >
            ...
            >
              <kbd>Enter</kbd>
              <span style={{ paddingRight: '1.5rem' }}>New dwelling</span>
              <kbd>E</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Save PNG</span>
              <kbd>S</kbd>
              <span>Style</span>
              ...
              <kbd>+/-</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Floors</span>
              <kbd>R</kbd>
              <span style={{ paddingRight: '1.5rem' }}>Rotate</span>
              <kbd>T</kbd>
              <span>Thickness</span>
            </div>
          </div>
          ...
          <button
            ...
            title={
              !activeScene
                ...
                : 'Capture current map and add it to the active scene'
            }
          >
            🗺️ Add Map to Scene
          </button>
      ...
      {activeGenerator === 'city' && (
        <div style={{ padding: '2rem', textAlign: 'center' }}>
          <p>City Generator temporarily disabled due to performance issues.</p>
          <p>
            Visit:{' '}
            <a
